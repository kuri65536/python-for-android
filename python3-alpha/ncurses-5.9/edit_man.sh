...
TERMINFO="/home/robbie/python-for-android/python3-alpha/thirdparty/share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /home/robbie/python-for-android/python3-alpha/ncurses-5.9/man_alias.sed ; then
cat >>/home/robbie/python-for-android/python3-alpha/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
CF_EOF2
		echo "...made /home/robbie/python-for-android/python3-alpha/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/robbie/python-for-android/python3-alpha/ncurses-5.9/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/robbie/python-for-android/python3-alpha/ncurses-5.9/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/robbie/python-for-android/python3-alpha/ncurses-5.9/man_alias.sed \
		< $i | sed -f /home/robbie/python-for-android/python3-alpha/ncurses-5.9/edit_man.sed >$TMP
